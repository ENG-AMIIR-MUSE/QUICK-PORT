...
export default function ShowCase() {
  return (
    <div className="max-w-[1200px] m-auto p-5 flex flex-col md:flex-row md:items-center md:justify-between h-[80vh] relative">
      ...
      <div className="mt-[50px] md:mt-0 w-full md:w-1/2 flex flex-col items-center md:items-start gap-6">
      ...
      <img
        className="w-full h-[290px] md:rounded-full md:w-[370px] md:h-[350px] object-center object-cover"
        src={face}
        alt="Amir Photo"
      />
      {/* Existing circles */}
